// pages/DetectionPage.jsx – moved from components/DetectionScreen.jsx
    ...
    <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col items-center justify-center gap-10">
      ...
      <div className="relative w-40 h-40 flex items-center justify-center">
        ...
        <motion.div
          ...
          className="w-14 h-14 rounded-full border-4 border-[var(--accent)]/20 border-t-[var(--accent)]"
        />

        {/* Centre dot */}
        <div className="absolute w-4 h-4 rounded-full bg-[var(--accent)]" />
      </div>
